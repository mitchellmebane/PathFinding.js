...
function pathTest(opt) {
    ...
    describe(name + 'TypedArray', function() {
        ...
        for (i = 0; i < scenarios.length; ++i) {
            ...
            height = scen.matrix.length;
            width = scen.matrix[0].length;
            
            // convert the scenario data to a Uint8Array
            matrix = new Uint8Array(width * height);
            for(r = 0; r < height; ++r) {
                matrix.set(scen.matrix[r], r * width);
            }
